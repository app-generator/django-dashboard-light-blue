...
**Open-Source Admin Dashboard** coded in **[Django Framework](https://www.djangoproject.com/)** on top of **Light Blue Dashboard** design (free version) - Provided by **AppSeed** [Web App Generator](https://appseed.us/app-generator).
...
- UI Kit: **[Light Blue Dashboard](https://github.com/flatlogic/light-blue-dashboard?ref=appseed)** (Free version) provided by **FlatLogic**
- **MIT License**
